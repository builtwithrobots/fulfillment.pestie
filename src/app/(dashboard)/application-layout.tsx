...
import { BugOff, ChartColumn, ClipboardList, Contact, LayoutGrid, ListChecks, Timer, Tv } from 'lucide-react'
...
const navSections: {
  ...
  {
    heading: 'Planning',
    items: [{ href: '/shifts', label: 'Shift Planning', icon: ClipboardList }],
  },
]
