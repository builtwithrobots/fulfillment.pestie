...
export default function OverviewPage() {
  return (
    <>
      ...
      {/* KPI tiles — stagger in, values count up, each on its own card */}
      <Stagger className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 xl:grid-cols-4" gap={0.08}>
        {kpis.map((k) => (
      ...
      <FadeIn delay={0.15}>
        <Card className="mt-6">
          <Subheading>7-day output trend</Subheading>
      ...
      <FadeIn delay={0.2}>
        <Card className="mt-6">
          <Subheading>Priority alerts</Subheading>
          <Table className="mt-4 [--gutter:--spacing(0)]">
            <TableHead>
              <TableRow>
      ...
      <FadeIn delay={0.25}>
        <Card className="mt-6">
          <Subheading>Line status</Subheading>
          <Table className="mt-4 [--gutter:--spacing(0)]">
            <TableHead>
              <TableRow>
                <TableHeader>Line</TableHeader>
            ...
            <TableBody>
              {lineStatus.map((l) => (
                <TableRow key={l.line}>
                  ...
                  <TableCell className="text-right text-zinc-500 tabular-nums">{l.target}</TableCell>
