      ...
      <Dialog open={open} onClose={setOpen} size="2xl">
        ...
        <DialogBody className="space-y-5 text-sm text-zinc-600 dark:text-zinc-300">
          <section>
            ...
            <p className="mt-1">
              List the steps of the process in order. Mark each one <em>Timed</em> (you&apos;ll clock it with a
              stopwatch) or <em>Documented</em> (notes only, no timing). Optionally add an hourly wage — that turns
              times into costs — and switch on the master timer to also clock the whole process end-to-end.
            </p>
          </section>
